...
void test_big_number_sub() {
    big_number_t *a1 = big_number_from_str("1", 1);
    big_number_t *b1 = big_number_from_str("0", 1);
    big_number_t *r1 = big_number_sub(a1, b1);
    assert(r1 != NULL);
    ...
    big_number_t *a2 = big_number_from_str("25", 2);
    big_number_t *b2 = big_number_from_str("5", 1);
    big_number_t *r2 = big_number_sub(a2, b2);
    assert(r2 != NULL);
    ...
    big_number_t *a3 = big_number_from_str("1000", 4);
    big_number_t *b3 = big_number_from_str("500", 3);
    big_number_t *r3 = big_number_sub(a3, b3);
    assert(r3 != NULL);
    ...
    big_number_t *a4 = big_number_from_str("12345", 5);
    big_number_t *b4 = big_number_from_str("6789", 4);
    big_number_t *r4 = big_number_sub(a4, b4);
    assert(r4 != NULL);
    ...
    big_number_t *a5 = big_number_from_str("100", 3);
    big_number_t *b5 = big_number_from_str("100", 3);
    big_number_t *r5 = big_number_sub(a5, b5);
    assert(r5 != NULL);
    ...
    big_number_t *a6 = big_number_from_str("9999", 4);
    big_number_t *b6 = big_number_from_str("1", 1);
    big_number_t *r6 = big_number_sub(a6, b6);
    assert(r6 != NULL);
    ...
    big_number_t *a7 = big_number_from_str("1", 1);
    big_number_t *b7 = big_number_from_str("2", 1);
    big_number_t *r7 = big_number_sub(a7, b7);
    assert(r7 != NULL);
    ...
    big_number_t *a8 = big_number_from_str("1000", 4);
    big_number_t *b8 = big_number_from_str("1001", 4);
    big_number_t *r8 = big_number_sub(a8, b8);
    assert(r8 != NULL);
    assert(strcmp(r8->number, "1") == 0);
    ...
    big_number_t *a9 = big_number_from_str("987654321", 9);
    big_number_t *b9 = big_number_from_str("987654321", 9);
    big_number_t *r9 = big_number_sub(a9, b9);
    assert(r9 != NULL);
    ...
    big_number_t *a10 = big_number_from_str("1000000", 7);
    big_number_t *b10 = big_number_from_str("1000001", 7);
    big_number_t *r10 = big_number_sub(a10, b10);
    assert(r10 != NULL);
    ...
    big_number_t *a11 = big_number_from_str("0012345", 7);
    big_number_t *b11 = big_number_from_str("0006789", 7);
    big_number_t *r11 = big_number_sub(a11, b11);
    assert(r11 != NULL);
    ...
    big_number_t *a12 = big_number_from_str("1000000000000000000000000000000", 31);
    big_number_t *b12 = big_number_from_str("999999999999999999999999999999", 30);
    big_number_t *r12 = big_number_sub(a12, b12);
    assert(r12 != NULL);
    ...
    big_number_t *a13 = big_number_from_str("999", 3);
    big_number_t *b13 = big_number_from_str("1000", 4);
    big_number_t *r13 = big_number_sub(a13, b13);
    assert(r13 != NULL);
    ...
    big_number_t *a14 = big_number_from_str("1000000000000000000", 19);
    big_number_t *b14 = big_number_from_str("2000000000000000001", 19);
    big_number_t *r14 = big_number_sub(a14, b14);
    assert(r14 != NULL);
    ...
    big_number_t *a15 = big_number_from_str("5000000000000000000000000000000", 31);
    big_number_t *b15 = big_number_from_str("10000000000000000000000000000000", 32);
    big_number_t *r15 = big_number_sub(a15, b15);
    assert(r15 != NULL);
    ...
    big_number_t *a16 = big_number_from_str("1234567890123456789012345678901", 31);
    big_number_t *b16 = big_number_from_str("2234567890123456789012345678901", 31);
    big_number_t *r16 = big_number_sub(a16, b16);
    assert(r16 != NULL);
